...
MrPokemonsHouse_MrPokemonScript:
	...
	writetext MrPokemonText_NeedSomething
	waitbutton
	closetext
	end
...
MrPokemonIntroText3:
	text "Don't ask me about"
	line "it! Just deliver"
	cont "it to PROF.ELM!"
	done
...
MrPokemonsHouse_OakText2:
	text "I have to get to"
	line "GOLDENROD for my"
	cont "usual radio show."

	para "Complete that damn"
	line "#DEX! Hah!"
	done
