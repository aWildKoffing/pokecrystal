...
FalknerGroup:
	...
	db  10,  HOOTHOOT,	BERRY,  	PECK, MUD_SLAP, GROWL, NO_MOVE
	db  12, FARFETCH_D,	SHARP_BEAK, PECK, MUD_SLAP, SAND_ATTACK, NO_MOVE
	db -1 ; end

; Add Teddiursa, buff Clefairy
WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 19, CLEFAIRY,  NO_ITEM,		HEADBUTT, SING, CHARM, ICE_PUNCH
	db 20, TEDDIURSA, NO_ITEM,  	LEER, LICK, MUD_SLAP, METAL_CLAW
	db 21, MILTANK,   MIRACLEBERRY, ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

; Swap in Ledian and Spinarak, take out gay cocoon pokemon
BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_ITEM_MOVES
	db 15, SPINARAK,  POISON_BARB,	POISON_STING, LEECH_LIFE, NO_MOVE, NO_MOVE
	db 15, LEDIAN,    NO_ITEM,		COMET_PUNCH, SUPERSONIC, REFLECT, CUT
	db 16, SCYTHER,   BERRY_JUICE,	QUICK_ATTACK, CUT, FURY_CUTTER, PURSUIT
	db -1 ; end

; Swap in Stantler and Misdreavus
MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_ITEM_MOVES
	db 24, STANTLER,   NO_ITEM,	 	 STOMP, HYPNOSIS, LEER, DOUBLE_KICK
	db 23, HAUNTER,    BERRY,	 	 HYPNOSIS, NIGHT_SHADE, CURSE, NIGHTMARE
	db 24, MISDREAVUS, SPELL_TAG,  	 PSYWAVE, CONFUSE_RAY, SHADOW_BALL, PERISH_SONG
	db 25, GENGAR,     MIRACLEBERRY, HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db -1 ; end

; Add Cloyster, Sneasel and Jynx
; Meant to be 6th gym, but still try to let it be a feasible challenge as 5th
PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 30, CLOYSTER,   NO_ITEM,  SPIKES, BUBBLEBEAM, AURORA_BEAM, RAIN_DANCE
	db 31, JYNX,       NO_ITEM,  CONFUSION, LOVELY_KISS, ICE_PUNCH, RAIN_DANCE
	db 32, SNEASEL,    NO_ITEM,  THIEF, ICE_PUNCH, METAL_CLAW, SHARPEN
	db 32, DEWGONG,    NO_ITEM,  RAIN_DANCE, SURF, AURORA_BEAM, REST
	db 33, PILOSWINE,  LEFTOVERS,  TAKE_DOWN, MAGNITUDE, ROCK_SMASH, BLIZZARD
	db -1 ; end

; Add Skarmory and Scizor, Swap in Magenton for Magnemite, Add Golem
; Definitely intended as 7th, should punish an early attempt unless they 
; are super prepared
JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 36, SKARMORY,  GOLD_BERRY,  SPIKES, WING_ATTACK, STEEL_WING, SWAGGER
	db 37, MAGNETON,  NO_ITEM,  THUNDERBOLT, SUPERSONIC, TRI_ATTACK, THUNDER_WAVE
	db 37, GOLEM,  	  NO_ITEM,  ROCK_SLIDE, EARTHQUAKE, SANDSTORM, THUNDERPUNCH
	db 38, STEELIX,   QUICK_CLAW, EARTHQUAKE, SANDSTORM, IRON_TAIL, CRUNCH
	db 38, SCIZOR,    FOCUS_BAND, METAL_CLAW, X_SCISSOR, SWORDS_DANCE, WING_ATTACK
	db -1 ; end

; Add in Hitmontop and Machamp (only 2 before, wtf?)
ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 30, HITMONTOP,  NO_ITEM,   TRIPLE_KICK, RAPID_SPIN, PURSUIT, DIG
	db 29, PRIMEAPE,   NO_ITEM,   KARATE_CHOP, RAGE, FOCUS_ENERGY, ROCK_THROW
	db 29, POLIWRATH,  NO_ITEM,   HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db 30, MACHAMP,    BLACKBELT_I,	DYNAMICPUNCH, KARATE_CHOP, ICE_PUNCH, FORESIGHT
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_ITEM_MOVES
	db 42, LAPRAS,     MINT_BERRY, 	RAIN_DANCE, SURF, ICE_BEAM, REST
	db 43, GYARADOS,   NO_ITEM,  	TWISTER, SURF, HYPER_BEAM, CRUNCH
	db 43, DRAGONAIR,  GOLD_BERRY,  RAIN_DANCE, THUNDER, THUNDER_WAVE, DRAGONBREATH
	db 43, DRAGONAIR,  GOLD_BERRY,  RAIN_DANCE, THUNDER, ICE_BEAM, SURF
	db 44, KINGDRA,    BRIGHTPOWDER,  SMOKESCREEN, SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end

Rival1Group:
	; Cherrygrove encounter
	...
	; Azalea town encounter

	; RIVAL1 (4)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 14, LARVITAR,	HARD_STONE,  BITE, SCREECH, SANDSTORM, ROCK_THROW
	db 16, ZUBAT,		BERRY,  LEECH_LIFE, SUPERSONIC, GUST, BITE
	db 18, BAYLEEF,		MIRACLE_SEED,  RAZOR_LEAF, POISONPOWDER, STUN_SPORE, SLEEP_POWDER
	db -1 ; end
	...
	db 14, LARVITAR,	HARD_STONE,  BITE, SCREECH, SANDSTORM, ROCK_THROW
	db 16, ZUBAT,		BERRY,  LEECH_LIFE, SUPERSONIC, GUST, BITE
	db 18, QUILAVA,		CHARCOAL, EMBER, MUD_SLAP, QUICK_ATTACK, NO_MOVE
	db -1 ; end
	...
	db 14, LARVITAR,	HARD_STONE,  BITE, SCREECH, SANDSTORM, ROCK_THROW
	db 16, ZUBAT,		BERRY,  LEECH_LIFE, SUPERSONIC, GUST, BITE
	db 18, CROCONAW,	BERRY,    RAGE, WATER_GUN, NO_MOVE, NO_MOVE
	db -1 ; end

	; Burned Tower encounter

	; RIVAL1 (7)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 22, GOLBAT,      BERRY,  LEECH_LIFE, GUST, BITE, CONFUSE_RAY
	db 20, KRABBY,  	NO_ITEM,  STOMP, BUBBLEBEAM, HARDEN, CUT
	db 20, LARVITAR,    HARD_STONE,  ROCK_THROW, BITE, SANDSTORM, MUD_SLAP
	db 24, BAYLEEF,    	BERRY_JUICE,  RAZOR_LEAF, SYNTHESIS, SLEEP_POWDER, POISONPOWDER
	db -1 ; end

	; RIVAL1 (8)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 22, GOLBAT,      BERRY,  LEECH_LIFE, GUST, BITE, CONFUSE_RAY
	db 20, ELEKID,  	NO_ITEM,  THUNDERPUNCH, QUICK_ATTACK, LIGHT_SCREEN, KARATE_CHOP
	db 20, LARVITAR,    HARD_STONE,  ROCK_THROW, BITE, SANDSTORM, MUD_SLAP
	db 24, QUILAVA,     BERRY_JUICE,  FLAME_WHEEL, SMOKESCREEN, SMOG, QUICK_ATTACK
	db -1 ; end

	; RIVAL1 (9)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 22, GOLBAT,      BERRY,  LEECH_LIFE, GUST, BITE, CONFUSE_RAY
	db 20, HOUNDOUR,  	NO_ITEM,  EMBER, SMOG, BITE, LEER
	db 20, LARVITAR,    HARD_STONE,  ROCK_THROW, BITE, SANDSTORM, MUD_SLAP
	db 24, CROCONAW,    BERRY_JUICE,  LEER, RAGE, WATER_GUN, BITE
	db -1 ; end

	; Goldenrod underground encounter

	; RIVAL1 (10)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 38, GOLBAT,     	NO_ITEM,  ACID, BITE, CONFUSE_RAY, WING_ATTACK
	db 37, KINGLER,  	MYSTIC_WATER,  STOMP, BUBBLEBEAM, PROTECT, GUILLOTINE
	db 38, PUPITAR,    	HARD_STONE,  ROCK_SLIDE, BITE, SANDSTORM, MUD_SLAP
	db 39, SNEASEL,    	NEVERMELTICE,  ICY_WIND, FAINT_ATTACK, METAL_CLAW, SCREECH
	db 40, MEGANIUM,   	MIRACLE_SEED, SYNTHESIS, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end

	; RIVAL1 (11)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 38, GOLBAT,     	NO_ITEM,  ACID, BITE, CONFUSE_RAY, WING_ATTACK
	db 37, ELEKID,  	MAGNET,  THUNDERPUNCH, SWIFT, LIGHT_SCREEN, KARATE_CHOP
	db 38, PUPITAR,    	HARD_STONE,  ROCK_SLIDE, BITE, SANDSTORM, MUD_SLAP
	db 39, SNEASEL,    	NEVERMELTICE,  ICY_WIND, FAINT_ATTACK, METAL_CLAW, SCREECH
	db 40, TYPHLOSION, 	CHARCOAL,  FLAME_WHEEL, SMOKESCREEN, QUICK_ATTACK, DIG
	db -1 ; end

	; RIVAL1 (12)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 38, GOLBAT,     	NO_ITEM,  ACID, BITE, CONFUSE_RAY, WING_ATTACK
	db 37, HOUNDOOM,  	FOCUS_BAND,  FLAME_WHEEL, SMOG, FAINT_ATTACK, SLASH
	db 38, PUPITAR,    	HARD_STONE,  ROCK_SLIDE, BITE, SANDSTORM, MUD_SLAP
	db 39, SNEASEL,    	NEVERMELTICE,  ICY_WIND, FAINT_ATTACK, METAL_CLAW, SCREECH
	db 40, FERALIGATR, 	GOLD_BERRY,  SLASH, SURF, BITE, SCARY_FACE
	db -1 ; end

	; Victory Road encounter

	; RIVAL1 (13)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 45, URSARING,    LEFTOVERS,  SLASH, FAINT_ATTACK, REST, SNORE
	db 46, GOLBAT,     	SHARP_BEAK,  ACID, BITE, CONFUSE_RAY, WING_ATTACK
	db 47, KINGLER,  	MYSTIC_WATER,  STOMP, CRABHAMMER, CROSS_CHOP, SWORDS_DANCE
	db 47, TYRANITAR,  	HARD_STONE,  ROCK_SLIDE, CRUNCH, SANDSTORM, THRASH
	db 45, SNEASEL,    	NEVERMELTICE,  ICY_WIND, FAINT_ATTACK, METAL_CLAW, SLASH
	db 48, MEGANIUM,   	MIRACLE_SEED,  SYNTHESIS, RAZOR_LEAF, LIGHT_SCREEN, BODY_SLAM
	db -1 ; end
	...
	db 45, URSARING,    LEFTOVERS,  SLASH, FAINT_ATTACK, REST, SNORE
	db 46, GOLBAT,     	SHARP_BEAK,  ACID, BITE, CONFUSE_RAY, WING_ATTACK
	db 47, ELECTABUZZ, 	MAGNET,  THUNDERBOLT, HEADBUTT, LIGHT_SCREEN, KARATE_CHOP
	db 47, TYRANITAR,  	HARD_STONE,  ROCK_SLIDE, CRUNCH, SANDSTORM, THRASH
	db 45, SNEASEL,    	NEVERMELTICE,  ICY_WIND, FAINT_ATTACK, METAL_CLAW, SLASH
	db 48, TYPHLOSION,  CHARCOAL,  FLAMETHROWER, SMOKESCREEN, HEADBUTT, DIG
	db -1 ; end
	...
	db 45, URSARING,    LEFTOVERS,  SLASH, FAINT_ATTACK, REST, SNORE
	db 46, GOLBAT,     	SHARP_BEAK,  ACID, BITE, CONFUSE_RAY, WING_ATTACK
	db 47, HOUNDOOM,  	FOCUS_BAND,  FLAMETHROWER, SMOG, FAINT_ATTACK, SLASH
	db 47, TYRANITAR,  	HARD_STONE,  ROCK_SLIDE, CRUNCH, SANDSTORM, THRASH
	db 45, SNEASEL,    	NEVERMELTICE,  ICY_WIND, FAINT_ATTACK, METAL_CLAW, SLASH
	db 48, FERALIGATR, 	MYSTIC_WATER,  SLASH, SURF, SCARY_FACE, ICE_PUNCH
	db -1 ; end
...
YoungsterGroup:
	...
	; YOUNGSTER (5)
	; FKA YOUNGSTER SAMUEL
	db "JEREMY@", TRAINERTYPE_ITEM
	db 11, MAREEP,	 MAGNET
	db 13, TOTODILE, MYSTIC_WATER
	db 10, SWINUB,   NEVERMELTICE
	db -1 ; end

	; YOUNGSTER (6)
	db "IAN@", TRAINERTYPE_MOVES
	db 11, MANKEY,  KARATE_CHOP, LEER, SCRATCH, NO_MOVE
	db 13, DIGLETT, MAGNITUDE, MUD_SLAP, SCRATCH, NO_MOVE
	db -1 ; end
...
SchoolboyGroup:
	...
	db 38, XATU,       WING_ATTACK, PSYBEAM, SWIFT, FUTURE_SIGHT
	db 40, TANGELA,    STUN_SPORE, SLEEP_POWDER, SLAM, MEGA_DRAIN
	db 38, YANMA,      CUT, DOUBLE_TEAM, WING_ATTACK, SUPERSONIC
	db 37, QUAGSIRE,   SURF, SLAM, AMNESIA, EARTHQUAKE
	db 39, SANDSLASH,  METAL_CLAW, MAGNITUDE, SLASH, SANDSTORM
	db -1 ; end

	; SCHOOLBOY (23)
	db "CHAD@", TRAINERTYPE_MOVES
	db 36, MR__MIME,  PSYBEAM, REFLECT, LIGHT_SCREEN, SUBSTITUTE
	db 38, MAGNETON,  THUNDERBOLT, THUNDER_WAVE, TRI_ATTACK, SUPERSONIC
	db 35, TAUROS, 	  PURSUIT, BODY_SLAM, THRASH, MUD_SLAP
	db -1 ; end

	; SCHOOLBOY (24)
	db "CHAD@", TRAINERTYPE_MOVES
	db 41, MR__MIME,   PSYCHIC_M, LIGHT_SCREEN, MEDITATE, BATON_PASS
	db 42, TAUROS, 	   EARTHQUAKE, PURSUIT, BODY_SLAM, THRASH
	db 42, MAGNETON,   THUNDERBOLT, THUNDER_WAVE, TRI_ATTACK, SUPERSONIC
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 11, PIDGEY,	NO_ITEM,  GUST, SAND_ATTACK, MUD_SLAP, NO_MOVE
	db  9, FEAROW,	SHARP_BEAK,  PECK, FURY_ATTACK, NO_MOVE, NO_MOVE
	db -1 ; end
...
LassGroup:
	...
	db 21, PSYDUCK,    SCRATCH, BUBBLE, DISABLE, CONFUSION
	db -1 ; end
	...
	; LASS (14)
	db "DANA@", TRAINERTYPE_MOVES
	db 24, FLAAFFY,    TACKLE, COTTON_SPORE, THUNDERSHOCK, THUNDER_WAVE
	db 24, PSYDUCK,    SCRATCH, BUBBLEBEAM, DISABLE, CONFUSION
	db 22, PONYTA,     FLAME_WHEEL, STOMP, TAIL_WHIP, MUD_SLAP
	db -1 ; end

	; LASS (15)
	db "DANA@", TRAINERTYPE_MOVES
	db 33, GOLDUCK,    BUBBLEBEAM, AMNESIA, CONFUSION, SCREECH
	db 33, AMPHAROS,   HEADBUTT, THUNDERBOLT, THUNDER_WAVE, COTTON_SPORE
	db 34, PONYTA,     FLAME_WHEEL, STOMP, TAKE_DOWN, FIRE_SPIN
	db -1 ; end

	; LASS (16)
	db "DANA@", TRAINERTYPE_MOVES
	db 37, GOLDUCK,    SURF, AMNESIA, CONFUSION, SCREECH
	db 37, AMPHAROS,   HEADBUTT, THUNDERBOLT, THUNDER_WAVE, COTTON_SPORE
	db 40, RAPIDASH,   FLAME_WHEEL, STOMP, MEGAHORN, FIRE_SPIN
	db -1 ; end

	; LASS (17)
	db "DANA@", TRAINERTYPE_MOVES
	db 40, AMPHAROS,   HEADBUTT, THUNDERBOLT, THUNDER_WAVE, COTTON_SPORE
	db 40, GOLDUCK,    AMNESIA, SURF, PSYCHIC_M, SCREECH
	db 44, RAPIDASH,   FIRE_BLAST, STOMP, MEGAHORN, EARTHQUAKE
	db -1 ; end
...
BeautyGroup:
	...
	db 16, MEOWTH,     BITE, PAY_DAY, NO_MOVE, NO_MOVE
	db 16, MEOWTH,     BITE, SLASH, NO_MOVE, NO_MOVE
	db -1 ; end
	...
	db 23, GLOOM,      ACID, SLEEP_POWDER, POISONPOWDER, ABSORB
	db 22, SKIPLOOM,   SYNTHESIS, RAZOR_LEAF, SLEEP_POWDER, GUST
	db -1 ; end
...
PokemaniacGroup:
	...
	db 12, SQUIRTLE,  WATER_GUN, WITHDRAW, TACKLE, TAIL_WHIP
	db -1 ; end
	...
	db 13, LICKITUNG,  LICK, SUPERSONIC, CUT, POUND
	db -1 ; end
...
GruntMGroup:
	; GRUNTM (1)
	; grunt #4 slowpoke well b1f
	db "EXECUTIVE@", TRAINERTYPE_ITEM_MOVES
	db 12, MEOWTH,	NO_ITEM, BITE, LICK, SCRATCH, CUT
	db 13, GRIMER,	BERRY,   ACID, POISON_GAS, POUND, HARDEN
	db -1 ; end

	; GRUNTM (2)
	; grunt #3 slowpoke well b1f
	db "SENIOR@", TRAINERTYPE_NORMAL
	db 10, NIDORAN_M
	db  4, SLOWPOKE
	db -1 ; end
...
BugCatcherGroup:
	...
	db  3, WEEDLE,	POISON_STING, NO_MOVE, NO_MOVE, NO_MOVE
	db  4, PARAS,	FURY_CUTTER, LEECH_LIFE, SCRATCH, NO_MOVE
	db -1 ; end

	; BUG_CATCHER (5)
	db "BENNY@", TRAINERTYPE_ITEM
	db 11, BEEDRILL, BERRY
	db -1 ; end
	...
	db 19, VENONAT,  POISONPOWDER, CONFUSION, LEECH_LIFE, SUPERSONIC
	db -1 ; end
	...
	db  8, WEEDLE,	 BERRY, POISON_STING, NO_MOVE, NO_MOVE, NO_MOVE
	db  8, WEEDLE,	 BERRY, POISON_STING, NO_MOVE, NO_MOVE, NO_MOVE
	db 10, BEEDRILL, BERRY, POISON_STING, FURY_ATTACK, NO_MOVE, NO_MOVE
	db -1 ; end
...
SuperNerdGroup:
	...
	db 11, MAGNEMITE, MAGNET, THUNDERSHOCK, NO_MOVE, NO_MOVE, NO_MOVE
	db 12, PIKACHU,   MAGNET, THUNDERSHOCK, THUNDER_WAVE, QUICK_ATTACK, NO_MOVE
	db 11, MAGNEMITE, MAGNET, THUNDERSHOCK, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
...
Rival2Group:
	...
	; RIVAL2 (1)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 64, SNEASEL,    	FOCUS_BAND,    NIGHT_SLASH, SHARPEN, METAL_CLAW, ICE_PUNCH
	db 63, URSARING,   	LEFTOVERS,     BODY_SLAM, REST, SNORE, BELLY_DRUM
	db 64, CROBAT,   	KINGS_ROCK,	   ACID, FLY, CONFUSE_RAY, HAZE
	db 64, KINGLER,     MYSTIC_WATER,  CRABHAMMER, STOMP, CROSS_CHOP, SWORDS_DANCE
	db 66, TYRANITAR,   MIRACLEBERRY,  EARTHQUAKE, CRUNCH, ROCK_SLIDE, OUTRAGE
	db 65, MEGANIUM,    MIRACLE_SEED,  GROWTH, GIGA_DRAIN, BODY_SLAM, TOXIC
	db -1 ; end
	...
	db 63, URSARING,   	LEFTOVERS,     BODY_SLAM, REST, SNORE, BELLY_DRUM
	db 64, CROBAT,   	KINGS_ROCK,	   ACID, FLY, CONFUSE_RAY, HAZE
	db 64, ELECTABUZZ,  MAGNET,		   THUNDERBOLT, LIGHT_SCREEN, DYNAMICPUNCH, BODY_SLAM
	db 66, TYRANITAR,   MIRACLEBERRY,  EARTHQUAKE, CRUNCH, ROCK_SLIDE, OUTRAGE
	db 65, TYPHLOSION,  CHARCOAL, 	   FLAMETHROWER, SMOKESCREEN, DIG, QUICK_ATTACK
	db -1 ; end
	...
	db 63, URSARING,   	LEFTOVERS,     BODY_SLAM, REST, SNORE, BELLY_DRUM
	db 64, CROBAT,   	KINGS_ROCK,	   ACID, FLY, CONFUSE_RAY, HAZE
	db 64, HOUNDOOM,    BLACKGLASSES,  FLAMETHROWER, CRUNCH, PAIN_SPLIT, PSYCHIC_M
	db 66, TYRANITAR,   MIRACLEBERRY,  EARTHQUAKE, CRUNCH, ROCK_SLIDE, OUTRAGE
	db 65, FERALIGATR, 	MYSTIC_WATER,  SLASH, SURF, ICE_PUNCH, CRUNCH
	db -1 ; end

	; Indigo plateau encounter , M/W rematches

	; RIVAL2 (4)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 68, SNEASEL,    	FOCUS_BAND,    NIGHT_SLASH, SHARPEN, METAL_CLAW, ICE_PUNCH
	db 68, URSARING,   	LEFTOVERS,     BODY_SLAM, REST, SNORE, BELLY_DRUM
	db 68, CROBAT,   	KINGS_ROCK,	   ACID, FLY, CONFUSE_RAY, SWORDS_DANCE
	db 68, KINGLER,     MYSTIC_WATER,  CRABHAMMER, STOMP, CROSS_CHOP, SWORDS_DANCE
	db 70, TYRANITAR,   MIRACLEBERRY,  EARTHQUAKE, CRUNCH, ROCK_SLIDE, OUTRAGE
	db 69, MEGANIUM,    MIRACLE_SEED,  GROWTH, GIGA_DRAIN, BODY_SLAM, TOXIC
	db -1 ; end
	...
	db 68, URSARING,   	LEFTOVERS,     BODY_SLAM, REST, SNORE, BELLY_DRUM
	db 68, CROBAT,   	KINGS_ROCK,	   ACID, FLY, CONFUSE_RAY, SWORDS_DANCE
	db 68, ELECTABUZZ,  MAGNET,		   THUNDERBOLT, LIGHT_SCREEN, DYNAMICPUNCH, BODY_SLAM
	db 70, TYRANITAR,   MIRACLEBERRY,  EARTHQUAKE, CRUNCH, ROCK_SLIDE, OUTRAGE
	db 69, TYPHLOSION,  CHARCOAL, 	   FLAMETHROWER, SUNNY_DAY, DIG, SOLARBEAM
	db -1 ; end
	...
	db 68, SNEASEL,    	FOCUS_BAND,    NIGHT_SLASH, SHARPEN, METAL_CLAW, ICE_PUNCH
	db 68, URSARING,   	LEFTOVERS,     BODY_SLAM, REST, SNORE, BELLY_DRUM
	db 68, CROBAT,   	KINGS_ROCK,	   ACID, WING_ATTACK, CONFUSE_RAY, SWORDS_DANCE
	db 68, HOUNDOOM,    BLACKGLASSES,  FLAMETHROWER, CRUNCH, PAIN_SPLIT, PSYCHIC_M
	db 70, TYRANITAR,   MIRACLEBERRY,  EARTHQUAKE, CRUNCH, ROCK_SLIDE, OUTRAGE
	db 69, FERALIGATR, 	MYSTIC_WATER,  SLASH, SURF, ICE_PUNCH, CRUNCH
	db -1 ; end
...
FirebreatherGroup:
	...
	db  7, KOFFING,  SMOG, POISON_GAS, SMOKESCREEN, NO_MOVE
	db 10, SLUGMA,	 SMOG, EMBER, NO_MOVE, NO_MOVE
	db -1 ; end

	; FIREBREATHER (6)
	db "WALT@", TRAINERTYPE_MOVES
	db 13, KOFFING,  SMOG, POISON_GAS, TACKLE, NO_MOVE
	db 13, KOFFING,  SMOG, POISON_GAS, TACKLE, NO_MOVE
	db 16, MAGMAR,   FIRE_PUNCH, SMOG, LEER, NO_MOVE
	db -1 ; end
...
JugglerGroup:
	...
	db 10, VOLTORB,  SCREECH, NO_MOVE, NO_MOVE, NO_MOVE
	db 12, VOLTORB,  SCREECH, SPARK, ROLLOUT, NO_MOVE
	db 14, VOLTORB,  SCREECH, SPARK, ROLLOUT, NO_MOVE
	db 16, VOLTORB,  SCREECH, SPARK, SONICBOOM, ROLLOUT
	db -1 ; end
...
PsychicGroup:
	...
	db 18, DROWZEE,    HYPNOSIS, DISABLE, DREAM_EATER, NO_MOVE
	db 21, GASTLY, 	   HYPNOSIS, SMOG, DREAM_EATER, NIGHT_SHADE
	db -1 ; end
	...
	db 14, ABRA,       HIDDEN_POWER, FLASH, NO_MOVE, NO_MOVE
	db 14, ABRA,       HIDDEN_POWER, FLASH, NO_MOVE, NO_MOVE
	db 16, KADABRA,    HIDDEN_POWER, KINESIS, CONFUSION, NO_MOVE
	db -1 ; end
...
PicnickerGroup:
	...
	db 10, HOPPIP,    BERRY,  RAZOR_LEAF, POISONPOWDER, GUST, SYNTHESIS
	db 12, BULBASAUR, BERRY,  POISONPOWDER, VINE_WHIP, LEECH_SEED, NO_MOVE
	db -1 ; end

	; PICNICKER (3)
	db "BROOKE@", TRAINERTYPE_MOVES
	db 16, PIKACHU,    THUNDERSHOCK, GROWL, QUICK_ATTACK, DOUBLE_TEAM
	db 18, TANGELA,	   VINE_WHIP, POISONPOWDER, SLEEP_POWDER, ABSORB
	db -1 ; end

	; PICNICKER (4)
	db "KIM@", TRAINERTYPE_ITEM
	db 14, BELLSPROUT,	MIRACLE_SEED
	db 15, PIDGEY, 		SHARP_BEAK
	db 17, VULPIX, 		CHARCOAL
	db -1 ; end
...
CamperGroup:
	...
	db 14, PSYDUCK, WATER_GUN, CONFUSION, DISABLE, NO_MOVE
	db -1 ; end

	; CAMPER (3)
	db "IVAN@", TRAINERTYPE_MOVES
	db 15, SUNKERN,  GROWTH, MEGA_DRAIN, NO_MOVE, NO_MOVE
	db 14, SUNFLORA, GROWTH, MEGA_DRAIN, RAZOR_LEAF, POUND
	db 14, SHUCKLE,  WRAP, WITHDRAW, ENCORE, CUT
	db -1 ; end

	; CAMPER (4)
	db "ELLIOT@", TRAINERTYPE_ITEM
	db 14, SANDSHREW,  NO_ITEM
	db 16, NIDORINO,   POISON_BARB
	db -1 ; end
...
SageGroup:
	...
	db 22, HAUNTER,  SPELL_TAG
	db -1 ; end

	; SAGE (6)
	db "PING@", TRAINERTYPE_ITEM
	db 20, MISDREAVUS,  TWISTEDSPOON
	db 20, GASTLY,      SPELL_TAG
	db -1 ; end
	...
	db 10, WEEPINBELL,	VINE_WHIP, WRAP, POISONPOWDER, NO_MOVE
	db 10, HOOTHOOT,	PECK, FORESIGHT, MUD_SLAP, NO_MOVE
	db -1 ; end
...
MediumGroup:
	; MEDIUM (1)
	db "MARTHA@", TRAINERTYPE_ITEM
	db 22, MISDREAVUS,  TWISTEDSPOON
	db -1 ; end

	; MEDIUM (2)
	db "GRACE@", TRAINERTYPE_ITEM
	db 20, HAUNTER,  SPELL_TAG
	db 20, HAUNTER,  SPELL_TAG
	db -1 ; end
...
KimonoGirlGroup:
	...
	db 19, FLAREON,  CHARCOAL
	db -1 ; end

	; KIMONO_GIRL (3)
	db "SAYO@", TRAINERTYPE_ITEM
	db 19, ESPEON,  TWISTEDSPOON
	db -1 ; end

	; KIMONO_GIRL (4)
	db "ZUKI@", TRAINERTYPE_ITEM
	db 19, UMBREON,  BLACKGLASSES
	db -1 ; end

	; KIMONO_GIRL (5)
	db "KUNI@", TRAINERTYPE_ITEM
	db 19, VAPOREON,  MYSTIC_WATER
	db -1 ; end

	; KIMONO_GIRL (6)
	db "MIKI@", TRAINERTYPE_ITEM
	db 19, JOLTEON,  MAGNET
	db -1 ; end
...
TwinsGroup:
	...
	db 19, CLEFAIRY,   SING, MINIMIZE, DOUBLESLAP, METRONOME
	db 19, JIGGLYPUFF, SING, DEFENSE_CURL, ROLLOUT, DISABLE
	db -1 ; end
