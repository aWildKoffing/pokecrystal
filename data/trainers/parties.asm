...
; Swap in Murkrow for Pidgey
FalknerGroup:
	; FALKNER (1)
	db "FALKNER@", TRAINERTYPE_ITEM_MOVES
	db  8,  MURKROW,	NO_ITEM,  PECK, MUD_SLAP, PURSUIT, NO_MOVE
	db  10, PIDGEOTTO,	BERRY,  TACKLE, MUD_SLAP, GUST, SAND_ATTACK
	db -1 ; end
...
; Swap in Ledian and Yanma, take out gay cocoon pokemon
BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_ITEM_MOVES
	db 15, LEDIAN,    NO_ITEM,	COMET_PUNCH, SUPERSONIC, REFLECT, NO_MOVE
	db 15, YANMA,     NO_ITEM,	GUST, QUICK_ATTACK, DOUBLE_TEAM, FURY_CUTTER
	db 16, SCYTHER,    BERRY,	QUICK_ATTACK, CUT, FURY_CUTTER, PURSUIT
	db -1 ; end
...
JasmineGroup:
	...
	db 38, SCIZOR,    FOCUS_BAND, METAL_CLAW, X-SCISSOR, SWORDS_DANCE, WING_ATTACK
	db -1 ; end
...
ChuckGroup:
	...
	db 30, MACHAMP,    BLACKBELT_T,	DYNAMICPUNCH, KARATE_CHOP, ICE_PUNCH, FORESIGHT
	db -1 ; end
...
Rival1Group:
	...
	db 22, GOLBAT,      NO_ITEM,  LEECH_LIFE, GUST, BITE, CONFUSE_RAY
	db 20, KRABBY,  	NO_ITEM,  STOMP, BUBBLEBEAM, HARDEN, CUT
	db 20, LARVITAR,    NO_ITEM,  ROCK_THROW, BITE, SANDSTORM, MUD_SLAP
	db 24, BAYLEEF,    	BERRY_JUICE,  RAZOR_LEAF, SYNTHESIS, SLEEP_SPORE, POISONPOWDER
	db -1 ; end
	...
	db 37, KINGLER,  	NO_ITEM,  STOMP, BUBBLEBEAM, PROTECT, GUILLOTINE
	db 38, PUPITAR,    	NO_ITEM,  ROCK_SLIDE, BITE, SANDSTORM, MUD_SLAP
	...
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 38, GOLBAT,     	NO_ITEM,  ACID, BITE, CONFUSE_RAY, WING_ATTACK
	db 37, HOUNDOOM,  	NO_ITEM,  FLAME_WHEEL, SMOG, FAINT_ATTACK, SLASH
	db 38, PUPITAR,    	NO_ITEM,  ROCK_SLIDE, BITE, SANDSTORM, MUD_SLAP
	db 39, SNEASEL,    	NEVERMELTICE,  ICY_WIND, FAINT_ATTACK, METAL_CLAW, SCREECH
	...
	db 46, GOLBAT,     	NO_ITEM,  ACID, BITE, CONFUSE_RAY, WING_ATTACK
	db 47, KINGLER,  	MYSTIC_WATER,  STOMP, CRABHAMMER, CROSS_CHOP, SWORDS_DANCE
	db 47, TYRANITAR,  	NO_ITEM,  ROCK_SLIDE, CRUNCH, SANDSTORM, THRASH
...
GruntMGroup:
	; GRUNTM (1)
	db "ROCKET ADMIN@", TRAINERTYPE_NORMAL
	db 10, HOUNDOUR
	db 14, KOFFING
	db 12, RHYHORN
	db -1 ; end
	...
	db "SR. GRUNT@", TRAINERTYPE_NORMAL
	db 10, RATTATA
	db 10, SLOWPOKE
	db 10, ZUBAT
	db -1 ; end
