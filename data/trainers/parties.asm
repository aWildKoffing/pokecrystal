...
MortyGroup:
	...
	db 23, STANTLER,   BERRY,	 	 STOMP, HYPNOSIS, LEER, DOUBLE_KICK
	db 23, HAUNTER,    NO_ITEM,	 	 HYPNOSIS, NIGHT_SHADE, CURSE, NIGHTMARE
	db 24, MISDREAVUS, NO_ITEM,  	 PSYWAVE, CONFUSE_RAY, SHADOW_BALL, PERISH_SONG
